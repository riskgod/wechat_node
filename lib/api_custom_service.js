...
exports.getRecords = (opts, callback)=> {
...
exports.getCustomServiceList =  (callback) =>{
...
exports.getOnlineCustomServiceList =  (callback)=> {
...
exports.addKfAccount =   (account, nick, password, callback)=> {
...
exports.updateKfAccount = (account, nick, password, callback) =>{
  // https://api.weixin.qq.com/customservice/kfaccount/add?access_token=ACCESS_TOKEN
...
exports.deleteKfAccount =  (account, callback)=> {
...
exports.setKfAccountAvatar =  (account, filepath, callback)=> {
...
exports.createKfSession = (account, openid, callback) =>{
...
exports.closeKfSession =   (account, openid, callback) =>{
...
exports.getKfSession =  (openid, callback)=> {
...
exports.getKfSessionList =   (account, callback)=> {
...
exports.getKfSessionWaitCase =  (callback) =>{
