...
exports.getWhichGroup =  (openid, callback) =>{
...
exports.createGroup = (name, callback)=> {
...
exports.moveUserToGroup =  (openid, groupId, callback) =>{
  // http请求方式: POST（请使用https协议）
...
exports.removeGroup = (groupId, callback)=> {
