...
exports.createGoodsGroup =  (groupName, productList, callback)=>{
  this.preRequest(this._createGoodsGroup, arguments);
};

exports._createGoodsGroup =  (groupName, productList, callback)=>{
  let data = {
    'group_detail': {
...
exports.deleteGoodsGroup =  (groupId, callback)=>{
  this.preRequest(this._deleteGoodsGroup, arguments);
};

exports._deleteGoodsGroup =  (groupId, callback)=>{
  let data = {
    'group_id': groupId
  };
...
exports.updateGoodsGroup =  (groupId, groupName, callback)=>{
  this.preRequest(this._updateGoodsGroup, arguments);
};

exports._updateGoodsGroup =  (groupId, groupName, callback)=>{
  let data = {
    'group_id': groupId,
    'group_name': groupName
  };
...
exports.updateGoodsForGroup =  (groupId, addProductList, delProductList, callback)=>{
  this.preRequest(this._updateGoodsForGroup, arguments);
};

exports._updateGoodsForGroup =  (groupId, addProductList, delProductList, callback)=>{
  let data = {
    'group_id': groupId,
    'product': []
  };
...
exports._getAllGroups =  (callback)=>{
...
exports._getGroupById =  (groupId, callback)=>{
  let data = {
    'group_id': groupId
  };
