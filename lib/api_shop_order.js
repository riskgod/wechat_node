 ...
 * 根据订单ID获取订单详情的未封装版本
 */
exports._getOrderById =  (orderId, callback)=>{
  let data = {
    'order_id': orderId
  };
 ...
 */
exports._getOrdersByStatus =  (status, beginTime, endTime, callback)=>{
  let data = {};
...
exports.setExpressForOrder =  (orderId, deliveryCompany, deliveryTrackNo, callback)=>{
 ...
 * 设置订单发货信息的未封装版本
 */
exports._setExpressForOrder =  (orderId, deliveryCompany, deliveryTrackNo, callback)=>{
  let data = {
    'order_id': orderId,
 ...
 * 关闭订单的未封装版本
 */
exports._closeOrder =  (orderId, callback)=>{
  let data = {
    'order_id': orderId
  };
