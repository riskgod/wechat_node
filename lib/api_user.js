...
exports.getUser =  (options, callback)=>{
  this.preRequest(this._getUser, arguments);
};


exports._getUser =  (options, callback)=>{
...
exports.batchGetUsers =  (openids, callback)=>{
 ...
 * 批量获取用户基本信息的未封装版本
 */
exports._batchGetUsers =  (openids, callback)=>{
...
exports.getFollowers =  (nextOpenid, callback)=>{
 ...
 * 获取关注者列表的未封装版本
 */
exports._getFollowers =  (nextOpenid, callback)=>{
...
exports.updateRemark =  (openid, remark, callback)=>{
  this.preRequest(this._updateRemark, arguments);
};


exports._updateRemark =  (openid, remark, callback)=>{
