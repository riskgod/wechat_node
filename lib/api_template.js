...
exports.setIndustry = (industryIds, callback)=>{
  this.preRequest(this._setIndustry, arguments);
};

exports._setIndustry =  (industryIds, callback)=>{
...
exports.getIndustry = (callback)=>{
  this.preRequest(this._getIndustry, arguments);
};

exports._getIndustry =  (callback)=>{
...
exports.addTemplate = (templateIdShort, callback)=>{
  this.preRequest(this._addTemplate, arguments);
};

exports._addTemplate =  (templateIdShort, callback)=>{
...
exports.sendTemplate =  (openid, templateId, url, data, callback, callback2)=>{
  this.preRequest(this._sendTemplate, arguments);
};

exports._sendTemplate =  (openid, templateId, url, data, callback, callback2)=>{
  /*
